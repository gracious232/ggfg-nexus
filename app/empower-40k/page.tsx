  ...
  return (
    <main className="min-h-screen bg-navy/5 text-navy">
      <section className="border-b border-navy/10 bg-[linear-gradient(135deg,_rgba(2,15,26,0.95),_rgba(3,20,33,1))] text-white">
        <div className="mx-auto max-w-6xl px-6 py-18 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-white/70">Empower 50K is GGFG’s flagship regional initiative designed to build founders, strengthen communities, and accelerate a new generation of entrepreneurial leadership.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 lg:px-8">
        <div className="rounded-[2rem] border border-navy/10 bg-navy p-10 text-white">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            {timeline.map((item) => (
              <div key={item.year} className="rounded-[1.25rem] border border-white/10 bg-navy/10 p-6">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 lg:px-8">
        <div className="flex flex-col gap-6 rounded-[2rem] border border-navy/10 bg-navy/10 p-8 shadow-sm lg:flex-row lg:items-center lg:justify-between">
          <div>
