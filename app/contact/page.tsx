...
export default function ContactPage() {
  return (
    <main className="min-h-screen bg-white text-navy">
      <section className="border-b border-navy/10 bg-[linear-gradient(135deg,_rgba(6,26,45,0.05),_rgba(255,255,255,1))]">
        <div className="mx-auto max-w-6xl px-6 py-24 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-gold">Contact</p>
            <h1 className="mt-4 text-4xl font-semibold leading-tight text-navy sm:text-5xl">Let’s build the next generation of founders together.</h1>
            <p className="mt-6 max-w-3xl text-lg leading-8 text-navy/70">For partnerships, support, and strategic engagement, we welcome conversations with institutions and leaders who share our long-term vision.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[2rem] border border-navy/10 bg-[#F7F8FA] p-8">
            <h2 className="text-3xl font-semibold text-navy">Connect with GGFG</h2>
          ...
          <div className="rounded-[2rem] border border-navy/10 bg-white p-8 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              ...
              <textarea className="min-h-36 w-full rounded-2xl border border-navy/10 bg-[#F7F8FA] px-4 py-3 text-sm outline-none" placeholder="Share your interest or partnership idea" />
